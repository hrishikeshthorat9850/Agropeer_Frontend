  ...
  const fetchNews = useCallback(
    async (page) => {
      try {
        ...
        if (apiError) {
          setError(apiError.message || "Failed to load news");
          return;
        }
  ...
  useEffect(() => {
    const fetchArticleDetail = async () => {
      ...
      try {
        ...
        if (apiError) {
          setArticleError(apiError.message || "Failed to load article");
          return;
        }
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                  Latest agricultural updates & insights
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="hidden md:block w-full max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-farm-600 max-w-2xl mx-auto">
              Stay updated with the latest news, updates, and insights from the
              agricultural world
            </p>
          </motion.div>
        </div>
