...
export default function ChatInputComposer({ sendMessage }) {
  ...
  return (
    <div className="sticky bottom-0 left-0 right-0 p-3 border-t dark:border-neutral-800 
      ...
      <div
        ...
        className={`
          ...
          ${showEmoji ? "scale-100 opacity-100" : "scale-95 opacity-0 pointer-events-none"}
        `}
      >
        <EmojiPicker
          theme={"dark"}
