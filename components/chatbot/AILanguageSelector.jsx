...
export default function AILanguageSelector({
  ...
  useEffect(() => {
    if (defaultLanguage) {
      ...
      // Fallback to first language if no default
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="text-xs font-medium text-gray-700 dark:text-gray-200 uppercase">
          {selectedLang ? selectedLang.label : "Eng"}
        </span>
      </button>
