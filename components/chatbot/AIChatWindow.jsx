    ...
    <>
      ...
      <div
        className={`
          ...
          backdrop-blur-2xl border border-gray-200 dark:border-white/10
      ...
      style={{
        ...(typeof window !== "undefined" && window.innerWidth < 768
          ? {
            ...
            right: "0",
            top: "auto",
            bottom: "0", // Safe area handled by padding
            height: "calc(100dvh - env(safe-area-inset-top))", // Full screen minus status bar
