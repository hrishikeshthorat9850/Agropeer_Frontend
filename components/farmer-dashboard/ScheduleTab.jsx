  ...
  if (loading) {
    return (
      <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-6 border border-white/30 shadow-md dark:bg-[#272727]">
        <p className="text-farm-700 dark:text-gray-200">Loading schedule...</p>
      </div>
    );
  }
      ...
      <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-6 border border-white/30 shadow-md dark:bg-[#272727]">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-farm-700 dark:text-gray-300 mt-1">
              Manage your farming tasks and activities
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 mt-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-farm-700 dark:text-gray-300">Filter:</span>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <div className="text-xs text-farm-600 dark:text-gray-400">Upcoming Tasks</div>
            </div>
          </div>
        </motion.div>
        <motion.div
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <div className="text-xs text-farm-600 dark:text-gray-400">Completed</div>
            </div>
          </div>
        </motion.div>
        <motion.div
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <div className="text-xs text-farm-600 dark:text-gray-400">High Priority</div>
            </div>
          </div>
        </motion.div>
        <motion.div
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <div className="text-xs text-farm-600 dark:text-gray-400">Pending</div>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="space-y-6">
        {sortedDates.length > 0 ? (
          ...
          <div className="bg-white/40 backdrop-blur-lg rounded-2xl p-12 border border-white/30 shadow-md dark:bg-[#272727] text-center">
            ...
            <h3 className="text-xl font-bold text-farm-900 dark:text-white mb-2">No tasks found</h3>
            <p className="text-farm-600 dark:text-gray-400">
              {filter === "all" ? "You're all caught up!" : `No ${filter.replace("_", " ")} tasks scheduled.`}
            </p>
          </div>
        )}
      </div>
