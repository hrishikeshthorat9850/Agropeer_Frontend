...
export default function Messages({messages,user,messagesEndRef,isTyping ,getMessageStatus,loading}){
    if (!user) return null;
    ...
    return(
        ...
        {loading ? (
            ...
            <div className="flex justify-center items-center h-full">
            <p className="text-blue-500 text-sm">No messages yet. Start the conversation!</p>
            </div>
        ) : (
