 ...
 */
export default function ProductFilters({ filters, onFiltersChange, availableDistricts = [] }) {
  ...
  const hasActiveFilters = filters.priceMin || filters.priceMax || filters.district;
